...
class DBHandler():
    ...
    dbpassword='sFv9iwKj'
    """ 
    Defining a function that will log into MySQL when the script is 
    being executed - uses information from class DBHandler above 
    """
    def __init__(self):
...
class Gene():
    ...
    def get_expression(self,Sample_ID):
        ...
        return exvals
        """ prints values for Expression and Sample_Id"""
